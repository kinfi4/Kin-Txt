...
from domain.entities import MessageGetEntity
from tests.factories import build_telegram_message
...
class TestMessageService(TestCase):
    def test__getting_posts(self):
        ...
        with(
            ...
            result = container.domain_services.message_service().get_user_posts(username=1,
