...
const ReportBlock = (props) => {
    ...
    return (
        <tr>
            <td className={selectReportMenuCss.reportRowCell}>
                <Link
                    className={`
                        ...
                        ${
                            props.reportStatus === REPORT_STATUS_POSTPONED
                                ? selectReportMenuCss.postponed
                                : ""
                        }
                        ${
                            props.reportStatus === REPORT_STATUS_PROCESSING
                                ? selectReportMenuCss.processing
                                : ""
                        }`}
            ...
            <td
                className={`${selectReportMenuCss.statusCell} ${
                    reportStatusToStatusClass[props.reportStatus]
                } ${selectReportMenuCss.reportRowCell}`}
                width={"95px"}
            >
                <div className={selectReportMenuCss.circle}></div>{" "}
                {props.reportStatus}
            </td>
            <td className={selectReportMenuCss.reportRowCell} width={"80px"}>
                {props.reportProcessingDate}
            </td>
            <td className={selectReportMenuCss.reportRowCell} width={"250px"}>
