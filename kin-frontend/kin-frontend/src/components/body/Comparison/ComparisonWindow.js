...
import StatisticalReport from "../Statistics/ReportVisualization/StatisticalReport";
import {WORD_CLOUD_REPORT} from "../../../config";
import WordCloudReport from "../Statistics/ReportVisualization/WordCloudReport";
...
const ComparisonWindow = ({firstReport, secondReport, reportsAreLoading, setNullComparisonReports}) => {
    ...
    if(reportsAreLoading) {
        return (
            <div className={comparisonCss.comparisonContainer}>
                <div className={comparisonCss.comparisonBlock}><LoadingSpinner width={100} height={100} marginTop={"30%"} /></div>
                <div className={comparisonCss.comparisonBlock}><LoadingSpinner width={100} height={100} marginTop={"30%"} /></div>
            </div>
        )
    }
        ...
        return (
            <div className={comparisonCss.comparisonContainer}>
                <div
                    ...
                    style={{color: "#fff", paddingTop: "300px", fontSize: "25px"}}
                >
    ...
    if(firstReport.reportType === WORD_CLOUD_REPORT) {
        return (
            <div className={comparisonCss.comparisonContainer}>
                <div className={comparisonCss.comparisonBlock}><WordCloudReport report={firstReport} showComparisonButton={false} /></div>
                <div className={comparisonCss.comparisonBlock}><WordCloudReport report={secondReport} showComparisonButton={false} /></div>
            </div>
        )
    }
    ...
    return (
        <div className={comparisonCss.comparisonContainer}>
            <div className={comparisonCss.comparisonBlock}><StatisticalReport report={firstReport} showComparisonButton={false} /></div>
            <div className={comparisonCss.comparisonBlock}><StatisticalReport report={secondReport} showComparisonButton={false} /></div>
        </div>
    );
};
