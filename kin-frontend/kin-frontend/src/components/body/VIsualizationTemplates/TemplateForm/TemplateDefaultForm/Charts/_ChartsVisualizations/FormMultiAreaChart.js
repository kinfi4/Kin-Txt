...
import {Legend, LineChart, Line, YAxis, XAxis, CartesianGrid, Area, AreaChart} from "recharts";
...
const FormMultiAreaChart = ({visualizationCategory, data, onClick, isSelected=false}) => {
    return (
        <div
